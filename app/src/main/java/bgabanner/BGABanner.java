...
import bgabanner.transformer.BGAPageTransformer;
import bgabanner.transformer.TransitionEffect;
import huohuo.cn.hncc.guidepage.R;

public class  BGABanner extends RelativeLayout implements BGAViewPager.AutoPlayDelegate,
    ...
    /**
     *  context.obtainStyledAttributes(attrs, R.styleable.BGABanner)
     *  获取属性样式
     *
     * */
