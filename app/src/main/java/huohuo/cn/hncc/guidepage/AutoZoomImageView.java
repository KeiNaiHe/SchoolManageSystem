...
public class AutoZoomImageView extends ImageView {
    ...
    public AutoZoomImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.setScaleType(ScaleType.MATRIX);
    }

    public AutoZoomImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        this.setScaleType(ScaleType.MATRIX);
    }


    public AutoZoomImageView init() {
        initInternalValues();
        initPicturePosition();
        return this;
    ...
    private void initInternalValues() {
        ...
        if (mDrawable == null) {
            throw new IllegalArgumentException("please set the source of AutoZoomImageView");
    ...
    private void startZoomInByScaleDelta(final float scaleDelta, long duration) {
        ...
        va.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                if (mOnZoomListener != null)
                    mOnZoomListener.onUpdate(AutoZoomImageView.this, value / scaleDelta);
        ...
        va.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(Animator animation) {
                if (mOnZoomListener != null) mOnZoomListener.onStart(AutoZoomImageView.this);
            ...
            public void onAnimationEnd(Animator animation) {
                if (mOnZoomListener != null) mOnZoomListener.onEnd(AutoZoomImageView.this);
            }
    ...
    public AutoZoomImageView setScaleDelta(float scaleDelta) {
    ...
    public AutoZoomImageView setDurationMillis(long durationMillis) {
    ...
    public AutoZoomImageView setOnZoomListener(OnZoomListener onZoomListener) {
