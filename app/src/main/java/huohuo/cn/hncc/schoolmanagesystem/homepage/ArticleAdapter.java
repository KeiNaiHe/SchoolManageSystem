...
import huohuo.cn.hncc.schoolmanagesystem.homepage.group.GroupRecyclerAdapter;
...
public class ArticleAdapter extends GroupRecyclerAdapter<String, Article> {
    ...
    protected void onBindViewHolder(RecyclerView.ViewHolder holder, Article item, int position) {
        ...
        mLoader.load(item.getImgUrl())
                .apply(new RequestOptions().placeholder(R.drawable.holder).error(R.drawable.holder).dontAnimate()
                .centerCrop())
                .into(h.mImageView);
    }
