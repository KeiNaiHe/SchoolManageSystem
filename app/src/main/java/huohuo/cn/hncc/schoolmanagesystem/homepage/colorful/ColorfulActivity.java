package huohuo.cn.hncc.schoolmanagesystem.homepage.colorful;
...
import huohuo.cn.hncc.schoolmanagesystem.homepage.group.GroupItemDecoration;
...
public class ColorfulActivity extends BaseActivity implements
    ...
    private int mYear;
    CalendarLayout mCalendarLayout = (CalendarLayout) findViewById(R.id.calendarLayout);
